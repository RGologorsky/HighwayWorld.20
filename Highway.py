...
class Highwayworld(IRLworld):
    ...
    def __init__(self, num_lanes, highway_len, num_speeds, max_num_cars, discount):
        """
        ...
        state = vector of len (#lanes * highway len) where each index has
        car id and current speed or (-1,-1)
        """
